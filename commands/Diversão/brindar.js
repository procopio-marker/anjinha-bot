...
'https://images-ext-1.discordapp.net/external/dES8IQP4xSEu_xG63-rnEHXMPEQiEGirjghUkGnhpoI/https/i.imgur.com/Hsh4W3y.gif?width=400&height=222'
   ...
   const embed = new Discord.MessageEmbed()
      .setColor('#ff58c3')
      .setTitle('<a:flushed_time:886020076296343552> Eu acho que aí tem coisa em')
      .setDescription(`<:emoji_coracaorosa:885848380813754439> - ${user} o membrx ${message.author} deseja brindar com você. Aceitas?`, avatar)
      .setFooter('Clique no emoji abaixo para aceitar!')

   const embed2 = new Discord.MessageEmbed()
      .setColor('#ff58c3')
      .setDescription(`<:emoji_coracaorosa:885848380813754439> - ${user} aceitou brindar com ${message.author}!`, avatar1)
      .setImage(rand)
   ...
   await message.channel.send(embed).then(msg => {
      ...
      msg.awaitReactions((reaction, user) => {
         ...
         if (reaction.emoji.name === 'R_certorosaTKF') {
